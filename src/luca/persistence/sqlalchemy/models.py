"""Private SQL rows for the initial Luca accounting schema."""
...
from luca.persistence.sqlalchemy.base import Base, UTCDateTime, WholeHundredths
...
class EntryRow(RecordColumns, Base):
    """Entry header; financial content is immutable through Luca repositories."""
