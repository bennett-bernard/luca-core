"""Optional SQL storage. Install luca-core[sql] or luca-core[postgres] to use it."""
...
from luca.persistence.sqlalchemy.repositories import translate_errors
from luca.persistence.sqlalchemy.unit_of_work import SqlAlchemyUnitOfWork
...
class SqlAlchemyStore:
    ...
    def __init__(
        ...
        *,
        ...
        self._engine = create_luca_engine(url, echo=echo)
